...
@pytest.mark.skip(reason="Avrotize Python JSON Structure converter has datetime encoder bug: calls datetime.datetime.isoformat(d) as unbound method instead of d.isoformat()")
